import ItemCriterion from "./ItemCriterion"

class ItemCriterionFactory {
	public constructor() {}

	public static create(pServerCriterionForm: string): ItemCriterion | null {
		let criterion: ItemCriterion | null = null
		let s: string = pServerCriterionForm.slice(0, 2)
		switch (s) {
			//     case "BI":
...
export default ItemCriterionFactory
